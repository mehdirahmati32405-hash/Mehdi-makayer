...
WELCOME_TEXT = (
    ...
    "یکی از گزینه‌های زیر را انتخاب کنید، یا مستقیم یک عکس بفرستید تا گزارش جدید شروع شود.\n"
...
async def menu_new_report(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    if callback.message is not None:
        await callback.message.answer("برای ثبت گزارش جدید، یک عکس از محل مورد نظر ارسال کنید.")
    await state.set_state(ReportForm.waiting_photo)
