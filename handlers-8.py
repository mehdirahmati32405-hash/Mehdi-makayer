...
@router.message(Command("amoozesh"))
...
@router.message(ReportForm.waiting_media, F.photo)
...
@router.message(ReportForm.waiting_media, F.voice)
...
@router.message(ReportForm.waiting_more_photos)
